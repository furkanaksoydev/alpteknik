...
(function () {
  ...
  const samsonItems = [
    ['2141-tip-4-termostatik-vana', '2141 TİP 4 Termostatik Vana', '2141 TİP 4 TERMOSTATİK VANA.jpg', 'Sıcaklık değişimlerine göre akışı düzenlemeye yardımcı termostatik vana.', 'dokumanlar/samson/2141-t1-termostatik-vana.pdf'],
    ['2231-termostat', '2231 Termostat', '2231 TERMOSTAT.jpeg', 'Proses sıcaklığının izlenmesi ve kontrol döngüsünün desteklenmesi için termostat.', 'dokumanlar/samson/2231-termostat.pdf'],
    ['3241-2-motorlu-2-yollu-kontrol-vanasi', '3241-2 Motorlu 2 Yollu Kontrol Vanası', '3241--2 MOTORLU  2 YOLLU KONT.VANSI.jpg', 'Motorlu aktüatörüyle hat akışını modüle eden iki yollu kontrol vanası.', 'dokumanlar/samson/3241-2-motorlu-2-yollu-vana.pdf'],
    ['3241-1-2-yollu-vana', '3241-1 2 Yollu Vana', '3241-1 2 YOLLU VANA.jpeg', 'Proses hattında akışın kontrolü için kullanılan iki yollu vana.', 'dokumanlar/samson/3241-vana.pdf'],
    ['3241-7-pnomatik-iki-yollu-kontrol-vanasi', '3241-7 Pnömatik İki Yollu Kontrol Vanası', '3241-7  PNÖMATİK İKİ  YOLLU KONTROL VANASI .jpg', 'Pnömatik aktüatörle akışı kontrol eden iki yollu vana çözümü.', 'dokumanlar/samson/3241-vana.pdf'],
    ['3244-2-3-yollu-vana', '3244-2 3 Yollu Vana', '3244-2 3 YOLLU VANA.jpeg', 'Karıştırma veya yönlendirme uygulamalarında kullanılan üç yollu vana.', 'dokumanlar/samson/3244-3-yollu-kontrol-vanasi.pdf'],
    ['3244-2-motorlu-2-yollu-kontrol-vanasi', '3244-2 Motorlu 2 Yollu Kontrol Vanası', '3244-2 MOTORLU 2 YOLLU KONT.VANASI.jpg', 'Motorlu aktüatörle hassas akış kontrolü sağlayan iki yollu vana.', 'dokumanlar/samson/3374-motor.pdf'],
    ['3351-pnomatik-on-off', '3351 Pnömatik On-Off Vana', '3351 PNÖMATİK ON-OFF.jpeg', 'Pnömatik kumandayla açık-kapalı hat kontrolü için kullanılan vana.', 'dokumanlar/samson/3351-pnomatik-on-off-vana.pdf'],
    ['3353-pnomatik-on-off', '3353 Pnömatik On-Off Vana', '3353 PNÖMATİK ON-OFF.jpg', 'Hızlı ve güvenilir açık-kapalı kontrol için pnömatik vana.', 'dokumanlar/samson/3353-pnomatik-vana.pdf'],
    ['3354-pnomatik-on-off', '3354 Pnömatik On-Off Vana', '3354 PNÖMATİK ON-OFF.jpeg', 'Otomasyon uygulamalarında pnömatik kumandayla çalışan on-off vana.', 'dokumanlar/samson/3354-pnomatik-on-off-vana.pdf'],
    ['3725-pozisyoner', '3725 Pozisyoner', '3725 POZİSYONER.jpeg', 'Aktüatör konumunu kontrol sinyaline göre hassas biçimde ayarlayan pozisyoner.', 'https://uk.samsongroup.com/document/t83940en.pdf'],
    ['3730-0-pozisyoner', '3730-0 Pozisyoner', '3730-0 POZİSYONER.jpeg', 'Kontrol vanası aktüatörleri için akıllı konumlandırma çözümü.', 'dokumanlar/samson/3730-pozisyoner.pdf'],
    ['3730-1-pozisyoner', '3730-1 Pozisyoner', '3730-1 POZİSYONER.jpeg', 'Kontrol vanası aktüatörünün istenen konuma güvenilir şekilde ulaşmasını destekleyen pozisyoner.', 'dokumanlar/samson/3730-pozisyoner.pdf'],
    ['4123-basinc-dusurucu', '4123 Basınç Düşürücü', '4123 BASINÇ DÜŞÜRÜCÜ.jpg', 'Hat çıkış basıncını istenen seviyede tutmaya yardımcı basınç düşürücü.', 'dokumanlar/samson/4123-basinc-dusurucu.pdf'],
    ['44-1b-basinc-dusurucu', '44-1B Basınç Düşürücü', '44-1B BASINÇ DÜŞÜRÜCÜ.jpeg', 'Proses hattında basıncı kontrollü biçimde azaltmak için kullanılan regülatör.', 'dokumanlar/samson/44-1b-basinc-dusurucu.pdf'],
    ['6111-ip-konverter', '6111 I/P Konverter', '6111 IP KONVERTER.jpeg', 'Elektrik akım sinyalini pnömatik basınç sinyaline dönüştüren I/P konverter.', 'https://argentina.samsongroup.com/document/t61110en.pdf']
  ];

  const samsonProducts = samsonItems.map(([id, name, fileName, description, sourceUrl]) => ({
    id: `samson-${id}`,
    name,
    brand: 'Samson',
    group: 'SAMSON',
