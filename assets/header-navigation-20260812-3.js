...
(function () {
  ...
  const productMenu = `
    ...
    </ul><button class="nav-toggle" type="button" data-menu-toggle onclick="window.AlpHeaderNavigation.toggleBranch(this)" aria-label="Vanalar alt menüsünü aç" aria-expanded="false"><i class="fa-solid fa-chevron-right"></i></button><a href="endustriyel-vana-grubu.html">Vanalar</a></li>
    <li class="menu-has-children"><ul class="submenu-panel">
    ...
    </ul><button class="nav-toggle" type="button" data-menu-toggle onclick="window.AlpHeaderNavigation.toggleBranch(this)" aria-label="Kompansatörler alt menüsünü aç" aria-expanded="false"><i class="fa-solid fa-chevron-right"></i></button><a href="kompansator-sistemleri.html">Kompansatörler</a></li>
    <li class="menu-has-children"><ul class="submenu-panel">
    ...
    </ul><button class="nav-toggle" type="button" data-menu-toggle onclick="window.AlpHeaderNavigation.toggleBranch(this)" aria-label="Seviye göstergeleri alt menüsünü aç" aria-expanded="false"><i class="fa-solid fa-chevron-right"></i></button><a href="kataloglar.html?category=seviye-kontrol">Seviye Göstergeleri</a></li>
