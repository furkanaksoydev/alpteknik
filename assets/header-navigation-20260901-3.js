...
(function () {
  ...
  const productMenu = `
    <li class="menu-has-children">
      ...
      <ul class="submenu-panel">
        ...
        <li class="menu-group"><a href="kataloglar.html?category=vanalar&amp;brand=Samson" style="display:inline;min-height:0;padding:0;color:inherit;font:inherit;letter-spacing:inherit;text-transform:inherit;">SAMSON</a></li>
        <li class="submenu-all"><a href="kataloglar.html?category=vanalar&amp;brand=Samson">SAMSON ürünlerini görüntüle <i class="fa-solid fa-arrow-right"></i></a></li>
    ...
    <li><a href="kataloglar.html?category=yangin-malzemeleri">Yangın Malzemeleri</a></li>
  ...
  function createHeader(header) {
    ...
    const actions = '<div class="header-actions"><a href="iletisim.html" class="btn-primary">Teklif İste</a></div>';
